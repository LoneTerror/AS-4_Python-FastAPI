...
RELATIONAL_FIELD_MAPPINGS: Dict[str, Dict[str, str]] = {
    ...
    'Employee': {
        'auditLogs': 'AuditLog',
        'createdDepartmentTypes': 'DepartmentType',
        'updatedDepartmentTypes': 'DepartmentType',
        'createdDepartments': 'Department',
        'updatedDepartments': 'Department',
        'createdDesignations': 'Designation',
        'updatedDesignations': 'Designation',
        'assignedEmployeeRoles': 'EmployeeRole',
        'createdEmployeeRoles': 'EmployeeRole',
        'employeeRoles': 'EmployeeRole',
        'revokedEmployeeRoles': 'EmployeeRole',
        'updatedEmployeeRoles': 'EmployeeRole',
        'creator': 'Employee',
        ...
        'createdRewardCatalogs': 'RewardCatalog',
        'updatedRewardCatalogs': 'RewardCatalog',
        'createdRewardCategories': 'RewardCategory',
        'updatedRewardCategories': 'RewardCategory',
        'createdRewardHistory': 'RewardHistory',
        'rewardsGranted': 'RewardHistory',
        'updatedRewardHistory': 'RewardHistory',
        'createdRoles': 'Role',
        'updatedRoles': 'Role',
        'createdStatuses': 'StatusMaster',
        'updatedStatuses': 'StatusMaster',
        'createdTransactionTypes': 'TransactionType',
        'updatedTransactionTypes': 'TransactionType',
